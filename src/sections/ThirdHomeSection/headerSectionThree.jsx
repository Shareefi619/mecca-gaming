...
import { logo, logoSticky, product1, product2, product6 } from '../../assets/images'
...
const HeaderSectionThree = () => {
    ...
    return (
        <>
            ...
            <header id="rtsHeader" className="rts-header2 rts-header3">
                            ...
                            <div className="container">
                                <div className="navbar-inner">
                                    ...
                                    <div className="heading">
                                        <p>
                                            We provide best quality in reasonable price |{" "}
                                    ...
                                    <div className="flex-wrapper">
                                        ...
                                        <Link className="hamburger-menu item" onClick={() => setSidebar(!sidebar)}>
